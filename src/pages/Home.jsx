...
function Home() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 px-6 md:px-[10%] pt-32 md:pt-40 pb-16 md:pb-20 bg-[#f6f1eb]">
        <div className="flex-1 text-center md:text-left animate-[fadeInUp_0.8s_ease-out]">
          <p className="text-[#8b5e3c] font-bold tracking-[3px] mb-4 text-sm md:text-base">GENE + Y = GENEY</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#2d1e17] leading-tight mb-6">
            Grants your <span className="text-[#a68a54]">coffee</span> desires
          </h1>
          <p className="text-[#5c4433] text-base md:text-lg max-w-md mx-auto md:mx-0 mb-8 leading-relaxed">
        ...
        <div className="flex-1 w-full animate-[fadeInUp_1s_ease-out]">
          <img
      ...
      {/* ABOUT TEASER */}
      <section className="px-6 md:px-[10%] py-16 md:py-24 bg-white flex flex-col md:flex-row items-center gap-10 md:gap-16">
        <img
        ...
        <div className="flex-1 text-center md:text-left">
          <p className="text-[#8b5e3c] font-bold tracking-[3px] mb-3 text-sm md:text-base">OUR STORY</p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#2d1e17] mb-5">More than just coffee</h2>
          <p className="text-[#5c4433] leading-relaxed mb-6 text-sm md:text-base">
      ...
      {/* MENU HIGHLIGHTS */}
      <section className="px-6 md:px-[10%] py-16 md:py-24 bg-[#f6f1eb]">
        <div className="text-center mb-10 md:mb-14">
          <p className="text-[#8b5e3c] font-bold tracking-[3px] mb-3 text-sm md:text-base">CUSTOMER FAVORITES</p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#2d1e17]">Fan Favorites</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {featured.map((item) => (
            <div
              key={item.name}
              className="bg-white rounded-2xl p-6 md:p-8 text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition duration-300"
            >
              <h3 className="text-lg md:text-xl font-bold text-[#2d1e17] mb-2">{item.name}</h3>
      ...
      {/* CTA */}
      <section className="px-6 md:px-[10%] py-16 md:py-20 bg-[#2d1e17] text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
          Ready to grab a cup?
        </h2>
        <p className="text-[#d9c7b8] mb-8 text-sm md:text-base">Open daily 7AM – 6PM. Reserve your table today.</p>
        <button
          onClick={() => navigate('/reservation')}
